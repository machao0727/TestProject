package com.dongyuwuye.compontent_widget.shadowlayout;
...
//    public static final int SHAPE_OVAL = 0x0010;
    ...
    private void initViews(AttributeSet attrs) {
        ...
        if (typedArray != null) {
            ...
            mRoundCornerRadius = typedArray.getDimension(R.styleable.ShadowLayout_shadowRoundRadius, dip2px(0));
            ...
            mCornerPosition = typedArray.getInt(R.styleable.ShadowLayout_round_corner, CORNER_ALL);
