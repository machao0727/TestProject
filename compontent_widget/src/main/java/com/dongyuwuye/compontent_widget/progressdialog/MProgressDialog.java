 ...
 * mMProgressDialog.show();      //显示'请稍后...'
 * mMProgressDialog.showNoText();//显示一个没有文字的等待框
 * mMProgressDialog.show(msg);   //显示一个文字为msg的等待框
 */
public class MProgressDialog implements View.OnClickListener {

    //常量
    private static final String defaultTextShow = "请稍后...";
