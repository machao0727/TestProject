...
public class MProgressWheel extends View {
    ...
    public MProgressWheel(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.MProgressWheel));
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.MProgressWheel_mn_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.MProgressWheel_mn_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.MProgressWheel_mn_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.MProgressWheel_mn_rimWidth, rimWidth);

        float baseSpinSpeed =
                a.getFloat(R.styleable.MProgressWheel_mn_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime =
                a.getInt(R.styleable.MProgressWheel_mn_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.MProgressWheel_mn_barColor, barColor);

        rimColor = a.getColor(R.styleable.MProgressWheel_mn_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.MProgressWheel_mn_linearProgress, false);

        if (a.getBoolean(R.styleable.MProgressWheel_mn_progressIndeterminate, false)) {
            spin();
        }
